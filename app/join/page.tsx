            ...
            <div className="font-alexandria pt-20 md:pt-28 flex flex-col break-words justify-center items-center pb-20">
                ...
                <div className="flex flex-col mx-2 md:ml-4">
                    ...
                    <div className="font-normal sm:text-xl mt-1 sm:mt-4">
                        <div className="flex whitespace-pre-wrap mt-4 align-center flex-wrap">
                            <div>1. Go to the   </div>
                            <a href="https://hq.girlswhocode.com/" target="_blank">
                                <button
                                type="button"
                                className="bg-buttonBlue text-gwc-darkblue font-bold rounded-md border-3 border-gwc-darkblue py-1 px-4 justify-center align-center text-md sm:text-xl md:text-2xl lg:text-3xl -mt-2 md:-mt-2 transition-all duration-200 hover:bg-gwc-darkblue hover:text-buttonBlue hover:border-buttonBlue hover:scale-105"
                                >
                                Girls Who Code HQ
                                </button>
                            </a>
                    ...
                    <div className="font-normal sm:text-xl mt-1 sm:mt-4">
                        <p className="flex whitespace-pre-wrap mt-4 align-center flex-wrap">
                            1. Go to{"   "}
                            <a href="https://knightconnect.campuslabs.com/engage/organizations" target="_blank">
                                <button
                                type="button"
                                className="bg-buttonBlue text-gwc-darkblue font-bold rounded-md border-3 border-gwc-darkblue py-1 px-4 justify-center align-center text-md sm:text-xl md:text-2xl lg:text-3xl -mt-2 md:-mt-2 transition-all duration-200 hover:bg-gwc-darkblue hover:text-buttonBlue hover:border-buttonBlue hover:scale-105"
                                >
